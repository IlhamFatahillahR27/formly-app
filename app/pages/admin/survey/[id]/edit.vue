<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    ...
    <UCard class="p-8 text-center border border-dashed border-gray-300 dark:border-gray-700">
      <UIcon name="i-heroicons-wrench-screwdriver" class="w-12 h-12 text-primary-500 mx-auto mb-3" />
      <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
        Fitur Builder (Phase 4)
      </h2>
      <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 max-w-md mx-auto">
        Editor survei interaktif dan Canvas Flow Designer akan diimplementasikan pada Phase 4.
      </p>
    </UCard>
  </div>
</template>
